          ...
          >
            ...
            <div className="space-y-6">
              <motion.div variants={fadeUp} className="rounded-3xl border border-border/70 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex flex-col gap-2 rounded-2xl bg-slate-50/70 p-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
              ...
              <motion.div variants={fadeUp} className="rounded-3xl border border-border/70 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-3">
                  {notificationPrefs.map((item) => (
                    <div
                      key={item.title}
                      className="flex flex-col gap-3 rounded-2xl bg-slate-50/70 p-4 sm:flex-row sm:items-start sm:justify-between"
                    >
                      <div>
                        <p className="text-sm font-semibold text-foreground">{item.title}</p>
                        <p className="text-xs text-muted-foreground">{item.description}</p>
                  ...
                  <div>
                    ...
                    <div className="mt-2 space-y-2">
                      {favoriteRoutes.map((route) => (
                        <div className="flex flex-col gap-2 rounded-2xl bg-slate-50/70 p-3 sm:flex-row sm:items-center sm:justify-between">
